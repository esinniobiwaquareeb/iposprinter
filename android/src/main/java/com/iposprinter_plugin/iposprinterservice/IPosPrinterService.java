...
abstract class Stub extends android.os.Binder implements IPosPrinterService
{
private static final java.lang.String DESCRIPTOR = "IPosPrinterService";
...
/**
 * Cast an IBinder object into an IPosPrinterService interface,
...
return new IPosPrinterService.Stub.Proxy(obj);
}
...
/**
    ...
    * @return
    */
@Override public void printerInit(IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void setPrinterPrintDepth(int depth, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void setPrinterPrintFontType(java.lang.String typeface, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @return
	*/
@Override public void setPrinterPrintFontSize(int fontsize, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void setPrinterPrintAlignment(int alignment, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void printerFeedLines(int lines, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void printBlankLines(int lines, int height, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void printText(java.lang.String text, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void printSpecifiedTypeText(java.lang.String text, java.lang.String typeface, int fontsize, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void PrintSpecFormatText(java.lang.String text, java.lang.String typeface, int fontsize, int alignment, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @return
	*/
@Override public void printColumnsText(java.lang.String[] colsTextArr, int[] colsWidthArr, int[] colsAlign, int isContinuousPrint, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
@Override public void printBitmap(int alignment, int bitmapSize, android.graphics.Bitmap mBitmap, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @return
	*/
@Override public void printBarCode(java.lang.String data, int symbology, int height, int width, int textposition, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @return
	*/
@Override public void printQRCode(java.lang.String data, int modulesize, int mErrorCorrectionLevel, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @param callback  结果回调
	*/
@Override public void printRawData(byte[] rawPrintData, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @param callback  结果回调
	*/
@Override public void sendUserCMDData(byte[] data, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @param callback  结果回调
	*/
@Override public void printerPerformPrint(int feedlines, IPosPrinterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    ...
    * @return
    */
public void setPrinterPrintFontType(java.lang.String typeface, IPosPrinterCallback callback) throws android.os.RemoteException;
/**
	* 设置字体大小, 对之后打印有影响，除非初始化
	* 注意：字体大小是超出标准国际指令的打印方式，
	* 调整字体大小会影响字符宽度，每行字符数量也会随之改变，
...
/**
    ...
    * @return
    */
public void printText(java.lang.String text, IPosPrinterCallback callback) throws android.os.RemoteException;
/**
    * 打印指定字体类型和大小文本，字体设置只对本次有效
    * 文字宽度满一行自动换行排版
    * @param text:	要打印的文字字符串
    ...
    * @return
    */
public void printSpecifiedTypeText(java.lang.String text, java.lang.String typeface, int fontsize, IPosPrinterCallback callback) throws android.os.RemoteException;
/**
    * 打印指定字体类型和大小文本，字体设置只对本次有效
    * 文字宽度满一行自动换行排版
    * @param text:	要打印的文字字符串
    ...
    * @return
    */
public void PrintSpecFormatText(java.lang.String text, java.lang.String typeface, int fontsize, int alignment, IPosPrinterCallback callback) throws android.os.RemoteException;
/**
	* 打印表格的一行，可以指定列宽、对齐方式
	* @param colsTextArr   各列文本字符串数组
	* @param colsWidthArr  各列宽度数组  总宽度不能大于((384 / fontsize) << 1)-（列数+1）
	...
	* @return
	*/
public void printColumnsText(java.lang.String[] colsTextArr, int[] colsWidthArr, int[] colsAlign, int isContinuousPrint, IPosPrinterCallback callback) throws android.os.RemoteException;
/**
    * 打印图片
    * @param alignment:	对齐方式 0--居左 , 1--居中, 2--居右, 默认居中
    * @param bitmapSize ： 位图大小，传入大小范围1~16,超出范围默认选择10 单位：24bit
...
/**
	...
	* @return
	*/
public void printBarCode(java.lang.String data, int symbology, int height, int width, int textposition, IPosPrinterCallback callback) throws android.os.RemoteException;
/**
	* 打印二维条码
	* @param data:			二维码数据
	* @param modulesize:	二维码块大小(单位:点, 取值 1 至 16 ),超出设置范围默认取值10
	...
	* @return
	*/
public void printQRCode(java.lang.String data, int modulesize, int mErrorCorrectionLevel, IPosPrinterCallback callback) throws android.os.RemoteException;
/**
	*打印原始的byte数据
	* @param rawPrintData    Byte 数据数据块
	* @param callback  结果回调
